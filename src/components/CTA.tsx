  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        >
          {/* Pulsing glow ring */}
          <div className="absolute -inset-3 rounded-full bg-gradient-to-r from-[var(--color-coral)] to-[var(--color-teal)] opacity-30 blur-lg animate-pulse-glow-ring" />
          <div className="absolute -inset-1.5 rounded-full bg-gradient-to-r from-[var(--color-coral)] to-[var(--color-teal)] opacity-20 animate-pulse-glow-ring" style={{ animationDelay: "0.5s" }} />

          <a
            href="https://apps.apple.com/us/app/clutch-picks/id6759183746"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center gap-3 px-12 py-6 rounded-full bg-gradient-to-r from-[var(--color-coral)] to-[var(--color-coral-light)] text-black font-bold text-lg sm:text-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_80px_rgba(122,157,184,0.45)] z-10"
          >
